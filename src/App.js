...
const analyticsStats = [
  { label: "Total Clicks", value: "7,200" },
  { label: "Active Links", value: "24" },
  { label: "Avg CTR", value: "18.4%" },
];
        ...
        <Container maxWidth="xl" sx={{ py: { xs: 4, md: 5 } }}>
          {activeView === "Dashboard" ? (
            <DashboardView
              ...
              recentOriginal={recentOriginal}
              copied={copied}
              handleCopy={handleCopy}
              historyRows={historyRows}
            />
          ) : (
            <AnalyticsView isDark={isDark} theme={theme} historyRows={historyRows} />
          )}
        </Container>
  ...
  return (
    <>
      ...
      >
        ...
        <HeroOrb isDark={isDark} theme={theme} />
      </Box>
      ...
      <HistorySection isDark={isDark} theme={theme} historyRows={historyRows} />
    </>
  );
}

function HeroOrb({ isDark, theme }) {
  return (
    <Box
      sx={{
        ...
        >
          ...
          <Box
            sx={{
              ...
              background: "linear-gradient(180deg, rgba(3,22,29,0.95), rgba(2,9,13,0.98))",
              position: "relative",
            }}
          >
            <Box
...
function RecentGenerationCard({ isDark, theme, recentTitle, recentOriginal, copied, handleCopy }) {
  return (
    <Paper
      elevation={0}
      sx={{
...
function HistorySection({ isDark, theme, historyRows }) {
  return (
    <Box sx={{ mt: { xs: 6, md: 8 } }}>
          ...
          {historyRows.map((row) => (
            ...
            >
              <Box>
                ...
                <Typography sx={{ mt: 0.5, color: "text.secondary" }}>{row.title}</Typography>
              </Box>
...
function AnalyticsView({ isDark, theme, historyRows }) {
  return (
    <Box sx={{ pt: { md: 4 } }}>
      <Stack spacing={1}>
        <Typography
        ...
        <Typography sx={{ maxWidth: 720, color: "text.secondary", fontSize: "1.05rem" }}>
          Monitor traffic quality, campaign lift, and engagement velocity across your
        ...
        {analyticsStats.map((stat) => (
          <Paper
            ...
            sx={{
              ...
              border: "1px solid",
              borderColor: isDark ? alpha("#ffffff", 0.07) : "#ebe8e1",
            }}
          >
            <Typography sx={{ color: "text.secondary", letterSpacing: "0.16em", fontSize: 12, textTransform: "uppercase", fontWeight: 700 }}>
              {stat.label}
            </Typography>
            <Typography sx={{ mt: 2, fontSize: { xs: "2rem", md: "2.6rem" }, fontWeight: 700 }}>
              {stat.value}
            </Typography>
          </Paper>
        ))}
      ...
      >
        ...
        >
          <Typography sx={{ fontSize: 22, fontWeight: 700 }}>Weekly Click Trend</Typography>
          <Stack direction="row" spacing={2} alignItems="end" sx={{ mt: 5, minHeight: 240 }}>
            {analyticsBars.map((bar) => (
              <Box key={bar.label} sx={{ flex: 1, textAlign: "center" }}>
                <Box
                  sx={{
                    ...
                    borderRadius: 999,
                    bgcolor: theme.palette.primary.main,
                    boxShadow: isDark ? "0 0 24px rgba(18, 207, 255, 0.18)" : "none",
                  }}
                />
        ...
        >
          <Typography sx={{ fontSize: 22, fontWeight: 700 }}>Top Performing Link</Typography>
          <Typography sx={{ mt: 3, color: theme.palette.primary.main, fontSize: 24, fontWeight: 700 }}>
            {historyRows[2].shortUrl}
          </Typography>
          <Typography sx={{ mt: 1, color: "text.secondary" }}>{historyRows[2].title}</Typography>
          <Divider sx={{ my: 3, borderColor: "divider" }} />
          <MetricBlock label="Clicks" value={historyRows[2].clicks} />
          <Box sx={{ mt: 3 }}>
            <MetricBlock label="Last Ping" value={historyRows[2].ping} />
          </Box>
        </Paper>
      </Box>
